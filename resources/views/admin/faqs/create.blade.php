...
<div class="max-w-3xl space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Create FAQ Entry</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Add enterprise advisory Q&A item.</p>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea id="answer" 
                          ...
                          class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-50 dark:bg-slate-950/60 border border-slate-300 dark:border-slate-200 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500 @error('answer') border-rose-500 @enderror">{{ old('answer') }}</textarea>
