...
@section('title', __('admin.pricing.add_new'))
@section('page_title', __('admin.pricing.add_new'))
...
<div class="max-w-4xl space-y-6" x-data="{ 
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">{{ __('admin.pricing.add_new') }}</h1>
        ...
        <div x-show="langTab === 'en'" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       required 
                       dir="ltr"
                       placeholder="e.g. Enterprise Accelerator" 
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('billing_period.en', 'month') }}" 
                       required 
                       dir="ltr"
            ...
            <div>
                ...
                <textarea id="description_en" 
                          ...
                          rows="2" 
                          dir="ltr"
                          placeholder="Brief description of the package audience..." 
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('whatsapp_message.en') }}" 
                       dir="ltr"
                       placeholder="e.g. Hi, I would like to subscribe to the Enterprise Accelerator plan." 
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-950/60 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500">
            </div>
                ...
                <template x-for="(item, index) in features_en" :key="index">
                    <div class="flex items-center gap-2">
                        <input type="text" 
                               ...
                               dir="ltr"
                               placeholder="e.g. Unlimited Active Integrations" 
        ...
        <div x-show="langTab === 'ar'" x-cloak class="space-y-4">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       required 
                       dir="rtl"
                       placeholder="مثال: باقة المؤسسات المتقدمة" 
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-950/60 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('billing_period.ar', 'شهرياً') }}" 
                       required 
                       dir="rtl"
                       placeholder="مثال: شهرياً، سنوياً، للمشروع" 
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-950/60 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <textarea id="description_ar" 
                          ...
                          rows="2" 
                          dir="rtl"
                          placeholder="وصف موجز للفئة المستهدفة من الباقة..." 
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       value="{{ old('whatsapp_message.ar') }}" 
                       dir="rtl"
                       placeholder="مثال: مرحباً، أود الاشتراك في باقة المؤسسات المتقدمة." 
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-950/60 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500">
            </div>
                ...
                <template x-for="(item, index) in features_ar" :key="index">
                    <div class="flex items-center gap-2">
                        <input type="text" 
                               ...
                               dir="rtl"
                               placeholder="مثال: تكاملات غير محدودة للأنظمة" 
                               class="flex-1 px-3 py-2 bg-slate-50 dark:bg-slate-950/60 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-xs focus:ring-2 focus:ring-indigo-500">
