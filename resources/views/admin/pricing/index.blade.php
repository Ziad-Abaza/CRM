...
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Pricing Plans & Tiered Packages</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Configure subscription and retainer pricing, featured highlights, and WhatsApp CTA triggers.</p>
        </div>
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.pricing.create') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-slate-900 dark:text-white bg-indigo-600 hover:bg-indigo-500 shadow-lg shadow-indigo-600/20 transition">
    ...
    <div class="bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-xl">
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-100 dark:bg-slate-800/30 transition">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('admin.pricing.edit', $plan) }}" class="p-1.5 text-slate-500 dark:text-slate-400 hover:text-indigo-400 hover:bg-slate-100 dark:bg-slate-800 rounded-lg transition" title="Edit">
        ...
        @else
            <div class="py-16 px-4 text-center">
                ...
                <h3 class="text-base font-bold text-slate-900 dark:text-white">No Pricing Packages Defined</h3>
                <p class="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-sm mx-auto">Set up scalable pricing packages with direct WhatsApp pre-filled quotes for high conversion.</p>
                <div class="mt-4">
                    <a href="{{ route('admin.pricing.create') }}" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-semibold text-slate-900 dark:text-white bg-indigo-600 hover:bg-indigo-500 transition">
