...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-extrabold text-white tracking-tight">Services & Capabilities</h1>
            <p class="text-sm text-slate-400 mt-1">Manage corporate services, highlight key deliverables, and configure feature points.</p>
        </div>
            ...
            <div class="sm:col-span-8">
                <div class="relative">
                    <input type="text" 
                           ...
                           class="w-full pl-10 pr-4 py-2 bg-slate-950/60 border border-slate-800 rounded-xl text-white text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
    ...
    <div class="bg-slate-900/80 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
                            ...
                            <tr class="hover:bg-slate-800/30 transition">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        @endif
                                        <div>
                                            <a href="{{ route('admin.services.edit', $service) }}" class="font-semibold text-white hover:text-indigo-400 transition">
                                                {{ $service->title }}
                                            </a>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('admin.services.edit', $service) }}" class="p-1.5 text-slate-400 hover:text-indigo-400 hover:bg-slate-800 rounded-lg transition" title="Edit Service">
                                        ...
                                        <form method="POST" action="{{ route('admin.services.destroy', $service) }}" onsubmit="return confirm('Are you sure you want to delete this service?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="p-1.5 text-slate-400 hover:text-rose-400 hover:bg-slate-800 rounded-lg transition" title="Delete Service">
        ...
        @else
            ...
            <div class="py-16 px-4 text-center">
                ...
                <h3 class="text-base font-bold text-white">No Services Found</h3>
                <p class="text-xs text-slate-400 mt-1 max-w-sm mx-auto">Get started by creating corporate service offerings to showcase on your landing page.</p>
                <div class="mt-4">
