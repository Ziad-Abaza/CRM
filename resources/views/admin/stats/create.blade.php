...
<div class="max-w-3xl space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Create Metric Counter</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Add quantitative milestone or performance statistic.</p>
        </div>
