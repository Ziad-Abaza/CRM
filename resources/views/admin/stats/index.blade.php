                    ...
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-200 dark:divide-slate-800/60">
                        @foreach($stats as $stat)
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-100 dark:bg-slate-800/30 transition">
                                ...
                                <td class="px-6 py-4 font-extrabold text-xl text-slate-900 dark:text-white font-mono">
                                    {{ $stat->value }}<span class="text-indigo-400 text-lg">{{ $stat->suffix }}</span>
                                </td>
                                <td class="px-6 py-4">
                                    <a href="{{ route('admin.stats.edit', $stat) }}" class="font-semibold text-slate-900 dark:text-white hover:text-indigo-400 transition">
                                        {{ $stat->label }}
                                    </a>
                                </td>
                                <td class="px-6 py-4 font-mono text-xs text-slate-500 dark:text-slate-400">
