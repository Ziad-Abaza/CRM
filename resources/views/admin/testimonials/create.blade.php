...
@section('title', __('admin.testimonials.add_new'))
@section('page_title', __('admin.testimonials.add_new'))

@section('content')
<div class="max-w-4xl space-y-6" x-data="{ langTab: 'en' }">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">{{ __('admin.testimonials.add_new') }}</h1>
        ...
        <div x-show="langTab === 'en'" class="space-y-4">
            ...
            <div>
                ...
                <textarea id="content_en" 
                          ...
                          required 
                          dir="ltr"
                          placeholder="Quote describing their experience and results..." 
        ...
        <div x-show="langTab === 'ar'" x-cloak class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" 
                           id="client_role_ar" 
                           name="client_role[ar]" 
                           value="{{ old('client_role.ar') }}" 
                           dir="rtl"
                           placeholder="مثال: الرئيس التنفيذي للتكنولوجيا" 
                           class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-950/60 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           dir="rtl"
                           placeholder="مثال: شركة التكنولوجيا المالية العالمية" 
                           class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-950/60 border border-slate-300 dark:border-slate-800 rounded-xl text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-indigo-500">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea id="content_ar" 
                          ...
                          required 
                          dir="rtl"
                          placeholder="نص رأي العميل وتجربته مع خدماتكم..." 
