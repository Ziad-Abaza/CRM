...
<div class="max-w-4xl space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Edit Client Testimonial</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Update testimonial details for "{{ $testimonial->client_name }}".</p>
        </div>
