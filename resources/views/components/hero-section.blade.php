@props([
    ...
    'subtitle' => 'Apex Corporate Solutions partners with institutional leaders to modernize legacy operations, implement high-yield automation, and safeguard governance at scale.',
    'ctaText' => 'Consult via WhatsApp',
    'ctaWhatsappMessage' => 'Hello Apex team, I would like to schedule an executive strategy session regarding our enterprise initiatives.',
    'ratingScore' => '4.9/5.0',
    'ratingCount' => '250+ Fortune 1000 & High-Growth Clients',
])
...
<section class="relative overflow-hidden bg-white dark:bg-slate-950 py-12 sm:py-16 lg:py-20 border-b border-slate-200 dark:border-slate-800/80 transition-colors duration-200">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid lg:grid-cols-12 gap-8 lg:gap-10 items-center">
                ...
                <div class="pt-3 flex items-center gap-3 sm:gap-4 border-t border-slate-200 dark:border-slate-800/80">
                    ...
                    <div class="text-xs">
                        <div class="flex items-center gap-1 text-amber-500 dark:text-amber-400 font-bold">
                            <span>★ ★ ★ ★ ★</span>
                            <span class="text-slate-800 dark:text-slate-200 ml-1 text-xs">{{ $ratingScore }}</span>
                        </div>
            ...
            <!-- Right Column: Interactive Diagnostic Matrix Visual -->
            <div class="lg:col-span-5 relative mt-4 lg:mt-0">
                <div class="rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white/90 dark:bg-slate-900/80 backdrop-blur-xl p-5 sm:p-6 shadow-xl shadow-slate-200/50 dark:shadow-slate-950/80 space-y-4 relative overflow-hidden transition-colors duration-200">
                    ...
                    <div class="grid grid-cols-2 gap-3 pt-1">
                        <div class="p-3 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 space-y-1">
                            <span class="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Audit Velocity</span>
                            <p class="text-base sm:text-lg font-black text-slate-900 dark:text-white">99.98%</p>
                            <span class="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">↑ Verified SLA</span>
                        </div>

                        <div class="p-3 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 space-y-1">
                            <span class="text-[10px] text-slate-500 dark:text-slate-400 uppercase tracking-wider font-semibold">Ledger Latency</span>
                            <p class="text-base sm:text-lg font-black text-slate-900 dark:text-white">&lt; 12ms</p>
                            <span class="text-[10px] text-blue-600 dark:text-blue-400 font-medium">Global Edge</span>
                        </div>
                    </div>

                    <!-- Interactive Diagnostic Terminal Box -->
                    <div class="p-3 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-[11px] font-mono text-slate-700 dark:text-slate-300 space-y-1.5">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 truncate">&gt; SOC2 Type II automated evidence: VALIDATED</p>
                        <p class="text-slate-600 dark:text-slate-400 truncate">&gt; WhatsApp Channel: CONNECTED</p>
                    </div>

                    <!-- Direct Connect Row -->
                    <div class="pt-2">
                        <x-whatsapp-cta-button 
                            text="Connect with Lead Architect" 
                            :message="'Hello Apex Team, I am looking to initiate an architecture audit.'"
