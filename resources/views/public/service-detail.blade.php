        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl space-y-4 sm:space-y-5">
                ...
                <nav class="flex items-center gap-1.5 sm:gap-2 text-xs font-semibold text-slate-500 dark:text-slate-400">
                    ...
                    <span>/</span>
                    <a href="{{ route('home') }}#services" class="hover:text-slate-900 dark:hover:text-white transition">Services</a>
                    <span>/</span>
                ...
                <div class="pt-1 flex flex-wrap items-center gap-3 sm:gap-4">
                    ...
                    <a href="{{ route('home') }}#services" class="inline-flex items-center gap-1.5 px-4 py-2 sm:py-2.5 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 text-xs sm:text-sm font-semibold border border-slate-200 dark:border-slate-800 transition">
                ...
                <div class="lg:col-span-4 space-y-6">
                    <div class="rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 p-5 sm:p-6 space-y-4 sticky top-24 backdrop-blur-xl shadow-lg shadow-slate-200/50 dark:shadow-slate-950">
                        <div class="space-y-1.5">
                            <span class="px-2 py-0.5 rounded bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 font-bold text-[10px] border border-emerald-200 dark:border-emerald-800 uppercase tracking-wider">Direct Hotline</span>
                            <h3 class="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Consult Managing Partner</h3>
                            <p class="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
        ...
        <section class="py-10 sm:py-14 bg-white dark:bg-slate-950 bg-grid-pattern border-t border-slate-200 dark:border-slate-800/80 transition-colors duration-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="text-lg sm:text-xl font-bold text-slate-900 dark:text-white">Other Enterprise Capabilities</h3>
                    <a href="{{ route('home') }}#services" class="text-xs font-bold text-blue-600 dark:text-blue-400 hover:underline">View All</a>
                </div>
                        ...
                        <div class="p-5 rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-500/40 transition duration-200 flex flex-col justify-between">
                            <div class="space-y-2">
                                <h4 class="font-bold text-slate-900 dark:text-white text-sm sm:text-base">
                                    <a href="{{ route('service.detail', $rel->slug) }}" class="hover:text-blue-600 dark:hover:text-blue-400 transition">
                                        {{ $rel->title }}
                                    </a>
                                </h4>
                            ...
                            <div class="pt-3 mt-3 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between">
                                <a href="{{ route('service.detail', $rel->slug) }}" class="text-xs font-bold text-blue-600 dark:text-blue-400 hover:underline">
                                    Details &rarr;
                                </a>
                            </div>
                        </div>
